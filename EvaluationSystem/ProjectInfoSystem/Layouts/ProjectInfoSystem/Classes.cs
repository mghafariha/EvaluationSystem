...
namespace ProjectInfoSystem.Layouts.ProjectInfoSystem
{
   ...
   public class WeeklyOperation
   {
    ...
    public class FixItem
    {
        ...
        public string Contract { get; set; }
        public int ContractId { get; set; }
        public string TemporaryDelivery { get; set; }
        public int TemporaryDeliveryId { get; set; }
        public int Period { get; set; }
         public decimal EquippedDeliveryLevel{get;set;}
         public decimal DrainageDeliveryLevel{get;set;}
         public decimal NetDeliveryLevel{get;set;}
        public decimal  NetDefectDeliminationLevel{get;set;}
        public decimal  EquippedDefectDeliminationLevel {get;set;}
        public decimal  DrainageDefectDeliminationLevel{get;set;}
       public decimal   NetDeadLineLevel{get;set;}
         public decimal EquippedDeadLineLevel{get;set;}
        public decimal  DrainageDeadLineLevel{get;set;}
         public decimal NetReminedLevel{get;set;}
         public decimal EquippedReminedLevel{get;set;}
        public decimal  DrainageReminedLevel{get;set;}
        public List<FixItemDetail> Items { get; set; }
    }


    public class FixItemDetail
    {
        public int Id { get; set; }
        public string Title { get; set; }
        public decimal  NetLevel { get; set; }
        public decimal EquippedLevel { get; set; }
        public decimal DrainageLevel { get; set; }
