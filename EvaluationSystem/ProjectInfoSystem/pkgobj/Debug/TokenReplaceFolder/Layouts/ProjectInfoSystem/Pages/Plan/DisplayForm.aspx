...
<asp:Content ID="Main" ContentPlaceHolderID="PlaceHolderMain" runat="server">
    ...
    <div id="mycontainer" class="display" style=" padding-right: 19%;" >
       ...
       <%--  <div class="newhead-priod" >
         ...
         <div class="newhead-commitType" >
           <span>نوع تعهد</span>
         <div id="commitType" class="display-head-data"  >  {{weeklyItem.TypeCommitment}}   </div>
               </div>
         ...
         <div   class="container" dir="rtl" ng-show="weeklyItem.Items.length>0">
         <div>تعهد و اجرای دوره های گذشته=اجرای سال 96 و تعهدهای قبل این دوره در سال 97</div>
            <table class="container" dir="rtl" ng-show="weeklyItem.Items.length>0">
                <thead>
                    <tr>
                        ...
                        <th class="Constructed" >تعهد و اجرای دوره های گذشته</th>
                        <th class="done-work" >باقی مانده تعهد 97</th>
